...
- [x] First declare and initialize a 'questions' array of type 'string[]'. The array should contain your own true or false questions.
...
- [x] Before we ask a question, we’ll need to define some empty variables. Declare these in the loop:
...
- [x] At this point, the program asks each question once and doesn’t do anything with the response. Run a sample code to make sure that everything is working fine.
